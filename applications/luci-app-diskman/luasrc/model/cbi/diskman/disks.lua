...
d:option(DummyValue, "model", translate("Disk Model"))
d:option(DummyValue, "sn", translate("Serial Number"))
d:option(DummyValue, "size_formated", translate("Disk Size"))
...
if dm.command.mdadm then
  ...
  if next(raid_devices) ~= nil then
    ...
    r:option(DummyValue, "size_formated", translate("Disk Size"))
...
if dm.command.btrfs then
  ...
  if next(btrfs_devices) ~= nil then
    ...
    -- table_btrfs:option(DummyValue, "size_formated", translate("Disk Size"))
