...
m = SimpleForm("partition", translate("Partition Management"))
...
s:option(DummyValue, "size_formated", translate("Disk Size"))
...
if not disk_info.p_table:match("Raid") then
  s_partition_table = m:section(Table, disk_info.partitions, translate("Partitions Info"))
